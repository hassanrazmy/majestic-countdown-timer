...
class Majestic_Countdown_Timer_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<form action="" id="alarm-clock-settings">
			<div class="alarm-clock-labels">
				<label class="selection-label" for="hours"><?php esc_html_e( 'Hours', 'majestic-countdown-timer' ); ?></label>
				<label class="selection-label" for="minutes"><?php esc_html_e( 'Minutes', 'majestic-countdown-timer' ); ?></label>
				<label class="selection-label" for="seconds"><?php esc_html_e( 'Seconds', 'majestic-countdown-timer' ); ?></label>
			</div>
			...
			<button id="alarm-clock-start" class="green-color mid-button default-btn alarm-clock-start"><?php esc_html_e('Start Clock', 'majestic-countdown-timer'); ?></button>
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e( 'Title', 'majestic-countdown-timer' ); ?></label>
