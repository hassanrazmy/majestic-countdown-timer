...
audioAlarm.setAttribute('src', majesticStrings.MW_URL+'/audio/alarm.mp3');
audioTicking.setAttribute('src', majesticStrings.MW_URL+'/audio/audio.mp3');
...
jQuery(document).ready(function() {
    ...
    jQuery('.ticking-btn').click( function(){
        ...
        if( $(this).hasClass('active') ){
            ...
            $(this).text( majesticStrings.tickingOffText );
        } else {
            audioTicking.muted = false;
            $(this).text( majesticStrings.tickingOnText );
        }
    });
